...
export default function Home() {
  ...
  return (
    <main className="bg-white text-gray-900">
      {/* Hero Section */}
      <section className="relative w-full h-[70vh] md:h-[90vh] bg-green-100 overflow-hidden">
        <div className="max-w-screen-2xl mx-auto h-full px-6 md:px-10 lg:px-16 xl:px-24">
          <div className="h-full flex flex-col md:flex-row items-stretch justify-between">
            ...
            <div className="w-full md:w-1/2 flex flex-col justify-center py-8 md:py-0">
              <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-green-900 leading-tight mb-4 sm:mb-6">
                Welcome to Jennie&apos;s Blog
              </h1>
              <p className="text-base sm:text-lg lg:text-xl text-green-800 leading-relaxed max-w-[60ch]">
      ...
      <section className="max-w-6xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-700 leading-relaxed mb-4">
            Jennie&apos;s Blog is dedicated to bringing you practical and
            inspiring content about health, wellness, and lifestyle. Whether you
            want to learn quick health hacks, dive into wellness routines, or
            explore balanced living tips — we’ve got you covered.
          </p>
