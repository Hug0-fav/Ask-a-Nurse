    ...
    <section className="w-full px-4 sm:px-8 md:px-12 lg:px-20 xl:px-28 py-10">
      ...
      <div className="flex justify-center mb-10">
        <input
          ...
          className="w-full max-w-md px-4 py-2 rounded-full bg-gray-100  text-sm text-gray-800 placeholder:text-gray-400  border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
        />
      </div>
